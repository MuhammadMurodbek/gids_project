    ...
    return (
        <Wrapper>
            ...
            <Container padding="10px 0">
                ...
                <TextTitle font="16px" align="left" top="30px"> Taqdimotlar, brifinglar, matbuot anjumanlari, seminarlar va treninglarda qatnashganmisiz?
                </TextTitle>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} md={9}>
                        <InputLabeled sizeLabel="15px" width="100%" placeholder="Nomini yozing" />
                    </Grid>
                    <Grid item xs={6} md={3}>
                        <InputLabeled sizeLabel="15px" width="100%" placeholder="Yilni yozing" />
                    </Grid>
                </Grid>
