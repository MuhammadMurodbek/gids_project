...
const Index = ({children}) => {
    ...
    useEffect(()=>{
        ...
        if(!location.pathname.includes('auth') && location.pathname!=='/'  &&   location.pathname!=='/blog' && location.pathname!=='/forgits' && !location.pathname.includes('request') && location.pathname!=='/about'  &&   location.pathname!=='/connect' && location.pathname!=='/gids' &&location.pathname !=='/seeprofile' && location.pathname !=='/application-form' && location.pathname!=='/cities' ){
            if(!isExpired){
