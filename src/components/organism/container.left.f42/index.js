                        ...
                        <Container position="relative" {...mediaContainerSecond} margin="25px 0 0 20px">
                            <FlexContainer {...mediaContainer} width="100%" alignItems="flex-start" justifyContent="space-between" >
                                ...
                                <Container {...mediaContainerSecondText} margin="-10px 0 0 15px">
                                    ...
                                    <div className="gid-info-personal">{state?.age + " yosh" || 'Mavjud emas'} | <span style={{ textTransform: "none" }}>{typeRole?.role === 'simple_user' ? "Foydalanuvchi " : typeRole?.role === "writer" ? "Yozma tarjimon" : typeRole?.role === "translator" ? "Og'izaki tarjimon" : "Gid"} </span> </div>
                                    {
                                        typeRole?.role === 'gid' ?
